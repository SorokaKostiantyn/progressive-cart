...
class CartServiceProvider extends ServiceProvider
{
	...
	public function boot()
	{
		if (function_exists('config_path')) {
			$this->publishes([__DIR__.'/config/config.php' => config_path('shopping_cart.php')], 'config');
		}
	}
    ...
    public function register()
    {
        ...
        $this->app->singleton(
            ...
            $session_key = '8ykokOKu3owDSsaq';

            return new Cart($storage, $events, $instanceName, $session_key, config('shopping_cart'));
            }
        );
    }
