...
class CartTestMultipleInstances extends PHPUnit\Framework\TestCase
{
    ...
    public function test_cart_multiple_instances()
    {
        ...
        $this->assertEquals(
            'shopping', $this->cart1->getInstanceName(), 'Cart 1 should have instance name of "shopping"'
        );
        ...
        $this->assertEquals(
            'wishlist', $this->cart2->getInstanceName(), 'Cart 2 should have instance name of "wishlist"'
        );
    }
}