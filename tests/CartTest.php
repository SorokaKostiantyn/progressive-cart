...
class CartTest extends PHPUnit\Framework\TestCase  {
    ...
    public function test_cart_update_with_attribute_then_attributes_should_be_still_instance_of_ItemAttributeCollection()
    {
        ...
        $this->assertInstanceOf('SorokaKostiantyn\Cart\ItemAttributeCollection', $item->attributes);
    ...
    /**
     * @expectedException SorokaKostiantyn\Cart\Exceptions\InvalidItemException
     */
